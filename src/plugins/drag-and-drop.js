...
const DragAndDrop = {
  ...
  _initDraggables(root = document) {
    const els = root === document ? document.querySelectorAll('[d-draggable="true"]') : (root.querySelectorAll ? root.querySelectorAll('[d-draggable="true"]') : []);
