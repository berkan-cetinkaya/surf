...
test.describe('Kanban User Journey (E2E)', () => {
  ...
  test('Journey 7: Sprint Management (Move from General Backlog to Active Sprint)', async ({ page }) => {
    await page.goto('/showcase/kanban/backlog');
    ...
    const newCard = page.locator('.tasks-list').last().getByText(testTitle).first().locator('xpath=..');
