...
export async function getBoard(req, reply) {
  ...
  if (req.headers['x-surf-request'] && req.query.mode === 'fragment') {
    const html = await req.server.view('templates/showcase/kanban/partials/board_main.ejs', {
      board,
      sprints,
      activeSprintId,
    });
...
export async function getBacklogPage(req, reply) {
  ...
  return reply.view('templates/showcase/kanban/backlog_page.ejs', {
    backlogBuckets,
    sprints,
  });
}
...
export async function createSprint(req, reply) {
  ...
  const html = await req.server.view('templates/showcase/kanban/partials/backlog.ejs', {
    backlogBuckets,
  });
...
export async function addTask(req, reply) {
  ...
  if (columnId === 'backlog') {
    ...
    const html = await req.server.view('templates/showcase/kanban/partials/backlog_content.ejs', {
      tasks: bucket.tasks,
  ...
  const html = await req.server.view('templates/showcase/kanban/partials/column_content.ejs', {
    column,
...
export async function getTaskModal(req, reply) {
  ...
  return reply.view('templates/showcase/kanban/partials/task_modal.ejs', { task });
}
...
export async function getTaskPage(req, reply) {
  ...
  return reply.view('templates/showcase/kanban/task_detail.ejs', { task, sprints });
}
...
export async function updateTaskDetails(req, reply) {
  ...
  return reply.redirect(`/showcase/kanban/task/${taskId}`);
}
...
export async function searchTasks(req, reply) {
  ...
  return reply.view('templates/showcase/kanban/partials/search_results.ejs', { tasks });
}
...
export async function addComment(req, reply) {
  ...
  const html = await req.server.view('templates/showcase/kanban/partials/comment.ejs', { comment });
